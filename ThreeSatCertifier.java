...
public class ThreeSatCertifier {
	...
	public static void main(String[] args) {
		String cnfFormula = "(NOT x1 OR X2 OR NOT x3) AND (NOT x1 OR x2 OR x3) AND (x1 OR NOT x2 OR x3)";
		
		ThreeSatCertifier certifier = new ThreeSatCertifier(cnfFormula);
		String[] certificates = { "(x1=0, x2=0, x3=0, x4=0)", "(x1=0, x2=0, x3=1, x4=1)", "(x1=0, x2=1, x3=0, x4=1)",
				"(x1=0, x2=1, x3=1, x4=1)", "(x1=1, x2=0, x3=0, x4=1)", "(x1=1, x2=0, x3=1, x4=1)",
				"(x1=1, x2=1, x3=0, x4=1)", "(x1=1, x2=1, x3=1, x4=1)" };
